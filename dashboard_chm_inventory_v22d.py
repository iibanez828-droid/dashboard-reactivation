...
def load_data():
    ...
    kits_sht    = pd.read_excel(EXCEL_PATH, sheet_name="Summary Inventory")
    ...
    for _df in [structural, rules, labour_sht, comp_costs, kits_sht, cerrejon_impact, component_impact, inventory_total]:
        ...
        for group_name, components in SUSPENSION_GROUPS.items():
            ...
            for comp_name in components:
                ...
                for cost_key, cost_value in cost_breakdown.items():
                    summary[cost_key][f"{group_key}_cost"] += float(cost_value)
                    summary[cost_key]["total_cost"] += float(cost_value)
                    summary[cost_key][f"{group_key}_count"] += 1
                    summary[cost_key]["total_count"] += 1
...
# Footer orange band (image4.png from the letterhead) embedded as base64
# so it works on Streamlit Cloud without extra file dependencies.
_FOOTER_BAND_B64 = (
    "iVBORw0KGgoAAAANSUhEUgAABBQAAAAoCAIAAADBij4OAAAW+ElEQVR4nO3deXhM1//A8fdkksme"
    "SCKRnRASSSyxlqIkdrFWS2lLi2q1KG3j25aqb7VKFz9a1WpLN60lWrvY6YLaQoidCAkhEpFNtpn5"
    "/ZHLzYyJDP3+ft8un9eT53HPueeee+be8Tz3M2e5GsA4CjQIIYQQQgghhGVGNJ9j899uhRBCCCGE"
    "EOKvQYIHIYQQQgghhFUkeBBCCCGEEEJYRYIHIYQQQgghhFUkeBBCCCGEEEJYRYIHIYQQQgghhFUk"
    "eBBCCCGEEEJYRYIHIYQQQgghhFUkeBBCCCGEEEJYRYIHIYQQQgghhFUkeBBCCCGEEEJYxfa/3QBL"
    "PIJw9Va2Swq5cvIejg2KRqNRtm9c5sZlC2VcauIZrGwXF3D1lOluDcHRairjCPoyvENx8VIzi/Mp"
    "yCb/irWt0tjg7o+zBzonNTPnAjcu4+iOdz0Lh+jLKMolNwOjocpqdc5EdCX0Qdx8KS8h5wLHt3B2"
    "FxirPMSzNm61sLU3ySwt4sIBaz+LEEIIIYT4p9IAxlEV//5pDJpLzFhl++xuZrW19sCwTkzcpibP"
    "7WFmGwvFOjzL0PnKtkHPnG6c2Kru1drxSamanBRIbgYjl9BykHk9eVc4tZPfvuTYZsvP61odzR+h"
    "zZOEPICjm/nehFfY/D5N+jJmZZWfqDifk9vZ/AGnfzbJ19jQeQI9XsPZ0/yQjCMsm8iJLSaZLt70"
    "fJ1WQ9SorLLLx3kzoso2CCGEEEIIYUTz+d9s2FK3SSbJug9Q/6FqDrHR8swyy7/9V8utFi0eZfxG"
    "Jm7Ds7b53pAHmHqEEd8R0dVC5GAlB1ea9OGlHXR/Vc3U6hizioHvW4gcgIBGjN9I7ItqTq0w3kgm"
    "drzlyEEIIYQQQgjr/CmHLd2fwKZEdjPP7D6J0zurOdDZkzGreLcNJfn3eeqwjsT/ynvtyT5/K6cT"
    "L6xD53ifFZrRaOj/Dqd2cG43wNBPaRxnUqC4AFsdtjolaWPDIx+Sc4GkHwGGLcLd9z/Tkqr0e4dL"
    "Kexd/H97lv+IgR+gNf3aH0jgzC9/qM46rWg1hISXqVmXjmNYP52Ca3+owj+uSV/CY5Rtg4G8TJLX"
    "7SfvCh6BpCQCuNQkPJbr6aTtp1EcqXuUFXXrtKJhFwzlJK9VVm3yj8KnPod+AnCtRWg75TbVrEuj"
    "XuicSDvAia1VvulFCCGEEEY0n/91g4evn2bXV0w9in+EknN+HzNamReL7M64DWpy4ZP8/m2VwQPg"
    "7MWrvyvTKytYEzyc2smiYearwdZtw/CvqVW/yqPuFjyAmy9TDuPmo+TnXeGtpspDp1bHsyvMXzJd"
    "mUHP0vHsmKcU/qS6JT7Xv82qydWU+SNiX+ThWYzRVV9SCCGEEEL8ORnRfP4XnfNwPYPfF9O4txo5"
    "gLIMpZmUjcoaPhW6xVcTJxVm83EcRblWNeNGJvuXMacbH3Sy8B6Jc7uZFsXCJ0jZqLyi4Z7kZbLo"
    "SXX5JrdajPxBGfiuL+WTviS8TKGlN5RdPMzszkrkQKVppnfSl3FqJ/MH/N9GDkD2eZOpGkIIIYQQ"
    "4q/pT9nz4BGEq6W1828rzCH7vHmx9GTLA/fNimUcwdFdWcISuJlnMk3izkMyjqAvwyvEZEZvcQFF"
    "OZZnylqkscHVB2dPk4FM1zPIv4Kju0lHx4Ukk4ETfhEmh2SeUJeRAXTORHQl9EHcfCkvITuN45s5"
    "t8d06IWGgCjz9hiNlBSSm2G+hqkQQgghhBAW/XmHLQkhhBBCCCH+VP7Cw5aEEEIIIYQQ/+8keBBC"
    "CCGEEEJYRYIHIYQQQgghhFUkeBBCCCGEEEJYRYIHIYQQQgghhFUkeBBCCCGEEEJYRYIHIYQQQggh"
    "hFUkeBBCCCGEEEJYRYIHIYQQQgghhFUkeBBCCCGEEEJYRYIHIYQQQgghhFX+F0mp+aI6SkpfAAAA"
    "AElFTkSuQmCC"
)
...
def _make_page_template(logo_bytes=None, eh5000_bytes=None):
    ...
    Replica of HTM_letterhead_LANDCROS.docx:
      • Header: Landcros logo top-left, EH5000 image top-right, thin orange rule below
      • Footer: full-width orange band (LANDCROS / Japanese Excellence) + contact text
    """
    ...
    # Pre-decode footer band once
    try:
        _footer_band_bytes = base64.b64decode(
            _FOOTER_BAND_B64.replace("\n", "").replace(" ", "")
        )
    except Exception:
        _footer_band_bytes = None

    HDR_H   = 50    # header zone height  (pt)
    ...
    def _on_page(canvas, doc):
        ...
        if logo_bytes:
            try:
                lw, lh = 108, 30
                logo_img = RLImage(_io.BytesIO(logo_bytes), width=lw, height=lh)
                logo_img.drawOn(canvas, MARGIN, PAGE_H - HDR_H + 10)
            except Exception:
                canvas.setFillColor(_ORANGE)
                canvas.setFont("Helvetica-Bold", 13)
                canvas.drawString(MARGIN, PAGE_H - HDR_H + 20, "LANDCROS")
        else:
            canvas.setFillColor(_ORANGE)
            canvas.setFont("Helvetica-Bold", 13)
            canvas.drawString(MARGIN, PAGE_H - HDR_H + 20, "LANDCROS")
        ...
        if eh5000_bytes:
            try:
                ew, eh = 68, 28
                eh_img = RLImage(_io.BytesIO(eh5000_bytes), width=ew, height=eh)
                eh_img.drawOn(canvas, PAGE_W - MARGIN - ew, PAGE_H - HDR_H + 11)
            except Exception:
                pass
        ...
        # ── FOOTER ───────────────────────────────────────────────────
        BAND_Y  = 34          # bottom of orange band (pt from page bottom)
        BAND_H  = 16          # band height (pt)
        BAND_W  = PAGE_W - 2  # nearly full width

        # Orange band — use image4.png from letterhead if available, else draw solid rect
        if _footer_band_bytes:
            try:
                band_img = RLImage(_io.BytesIO(_footer_band_bytes),
        ...
        # Contact text below the band
        canvas.setFont("Helvetica", 5.5)
        canvas.setFillColor(_GREY)
        canvas.drawString(MARGIN, 23,
            "200 Woodlawn Road West, Guelph, Ontario N1H 1B6, Canada  |  "
            "Tel: +1 (519) 823-2000  |  www.landcros.com")
        canvas.drawRightString(PAGE_W - MARGIN, 23,
            f"Page {doc.page}")

        # Thin rule above contact text
...
def _add_gantt_section(story, styles, report_df):
    ...
    story.append(_fig_to_pdf_element(build_gantt_fig(report_df), width=680, height=420))
    story.append(Spacer(1, 10))

    gantt_df = report_df[["DT", "Total Labour", "Total_Cost"]].copy()
    gantt_df = gantt_df.sort_values(["Total Labour", "Total_Cost"], ascending=[True, True]).head(30)
    table_data = [["DT", "Total Labour Hours", "Total Labour Days", "Total Cost"]]
    for _, row in gantt_df.iterrows():
    ...
    story.append(_pdf_table(table_data, col_widths=[90, 110, 110, 100]))
...
def build_dashboard_pdf(report_tab, include_all_tabs=False,
    ...
    section_builders = {
        "Fleet Overview":         lambda: _add_fleet_overview_section(story, styles, df, figs),
        "Cost Analysis per Truck":lambda: _add_cost_analysis_section(story, styles, df, figs),
        "Kit Analysis":           lambda: _add_kit_analysis_section(story, styles, df, figs),
        "Reactivation Gantt":     lambda: _add_gantt_section(story, styles, df),
        "Inventory Analysis":     lambda: _add_inventory_section(story, styles, df),
        "Part List":              lambda: _add_part_list_section(story, styles),
    }
...
with st.sidebar:
    ...
    current_tab_pdf = build_dashboard_pdf(
        report_tab_choice,
    ...
    st.download_button(
        "📥 Export Tab Report",
        data=current_tab_pdf,
        file_name=f"EH5000_{report_tab_choice.replace(' ', '_')}_report.pdf",
        mime="application/pdf",
        use_container_width=True,
    )

    full_project_pdf = build_dashboard_pdf(
        report_tab_choice,
...
with tab_inventory:
    ...
    # ==========================================================
    cer_impact_col = "Impact Cerrejon inventory"  # Unified column name
    comp_impact_col = "Impact Cerrejon inventory"  # Unified column name
    # ==========================================================
    # TOTALS
    # ==========================================================
    cer_impact_col = "Impact Cerrejon inventory"  # Normalized column name
    comp_impact_col = "Impact Cerrejon inventory"  # Same for component impact
    
    # Ensure we always operate on a Series (not a scalar) so .fillna() exists
    if cer_impact_col in cerrejon_impact.columns:
        cer_series = cerrejon_impact[cer_impact_col]
    else:
        cer_series = pd.Series(0, index=cerrejon_impact.index)
    total_cer = pd.to_numeric(cer_series, errors="coerce").fillna(0).sum()

    if comp_impact_col in component_impact.columns:
        comp_series = component_impact[comp_impact_col]
    else:
        comp_series = pd.Series(0, index=component_impact.index)
    total_comp = pd.to_numeric(comp_series, errors="coerce").fillna(0).sum()
