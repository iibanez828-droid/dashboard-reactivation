...
with k1:
    st.markdown(
        f"""
        <div class="kpi-card">
            <div class="kpi-label">TOTAL KIT TYPES</div>
            <div class="kpi-value">{int(total_kit_types) if total_kit_types is not None else 0}</div>
            <div class="kpi-sub">types applied</div>
        </div>
        """,
        unsafe_allow_html=True
    )
...
with k2:
    st.markdown(
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value">{int(total_quantity) if total_quantity is not None else 0}</div>
            <div class="kpi-sub">units all kits</div>
        </div>
        """,
        unsafe_allow_html=True
    )
...
with k3:
    st.markdown(
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value">${total_labour_cost:,.0f}</div>
...
with k4:
    st.markdown(
        f"""
        <div class="kpi-card">
            <div class="kpi-label">TOTAL PARTS COST</div>
            <div class="kpi-value">${parts_cost:,.0f}</div>
            <div class="kpi-sub">USD (parts only)</div>
        </div>
        """,
        unsafe_allow_html=True
    )
...
with k5:
    st.markdown(
        f"""
        <div class="kpi-card">
            <div class="kpi-label">TOTAL KIT COST</div>
            <div class="kpi-value">${total_kit_cost:,.0f}</div>
            <div class="kpi-sub">USD (labour + parts)</div>
        </div>
        """,
        unsafe_allow_html=True
    )
